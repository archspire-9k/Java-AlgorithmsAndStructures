 ...
 */
public class LLNode<Double> {
  /** the element stored in the node */
  private double element;
  
  /** a reference to the next node of the list */
  private LLNode<Double> next;
   ...
   */
  public LLNode(double element, LLNode<Double> next) {
  ...
  /*
   * Set the new element for the node
   ...
   */
  public void setNext(LLNode<Double> next) {
    this.next = next;
  }
  ...
  public void insertAfter(T element) {
    LLNode<T> node = new LLNode<T>(element, this.getNext());
    this.setNext(node);                             
  }
