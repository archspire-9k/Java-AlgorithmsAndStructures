...
public class Employee {
  ...
  /**
   * Overriding Object's toString method to give the name, number and salary of the employee
  ...
  /** 
   * Overriding Object's equals method.  Two employees are equal if their employee numbers
   * match.
